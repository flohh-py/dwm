...
static const char *fonts[] = {"monospace:size=10", "agave Nerd Font:size=10",
                              "FontAwesome:size=10"};
...
static Key keys[] = {
    ...
    {MODKEY, XK_F1, spawn, SHCMD("lvide")},
    {MODKEY, XK_F2, spawn, SHCMD("brave-browser")},
    {MODKEY, XK_F3, spawn, SHCMD("thunar")},
    {MODKEY, XK_F4, spawn, SHCMD("arandr")},
    {MODKEY, XK_F5, spawn, SHCMD("pavucontrol")},
    {MODKEY, XK_F6, spawn, SHCMD(TERMINAL " -e nmtui")},
    {MODKEY, XK_F12, spawn, SHCMD("dwmblocks &")},
    ...
    {MODKEY | ShiftMask, XK_q, spawn, SHCMD("dmenu_power")},
    {MODKEY, XK_0, spawn, SHCMD("slock")},
    TAGKEYS(XK_1, 0) TAGKEYS(XK_2, 1) TAGKEYS(XK_3, 2) TAGKEYS(XK_4, 3) TAGKEYS(
        ...
        TAGKEYS(XK_9, 8){
            ...
            SHCMD("pamixer --allow-boost -d 5 && pkill -RTMIN+11 dwmblocks")},
    {0, XF86XK_AudioMute, spawn,
     SHCMD("pamixer -t && pkill -RTMIN+11 dwmblocks")},
    {0, XF86XK_AudioRaiseVolume, spawn,
     SHCMD("pamixer --allow-boost -i 5 && pkill -RTMIN+11 dwmblocks")},
